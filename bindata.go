...
func assetsIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/index.html", size: 3863, mode: os.FileMode(420), modTime: time.Unix(1484077266, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
